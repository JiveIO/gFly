...
var (
	authURL         string = utils.CopyString("https://www.facebook.com/dialog/oauth")
	tokenURL        string = utils.CopyString("https://graph.facebook.com/oauth/access_token")
	endpointProfile string = utils.CopyString("https://graph.facebook.com/me?fields=")
)
...
// Provider is the implementation of `oauth.Provider` for accessing Facebook.
